...
# my custom things
INCLUDE_DIRS          += -I${FREERTOS_DIR}/ConfigUnix

SOURCE_FILES          := $(wildcard *Linux.c)
SOURCE_FILES          += my_main.c
...
#config file
SOURCE_FILES          += $(wildcard ${FREERTOS_DIR}/ConfigUnix/*.c)
SOURCE_FILES          += ${FREERTOS_DIR}/ConfigUnix/console.c
